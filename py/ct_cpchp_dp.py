...
file_out = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_cpchp_dp.ttl"
...
for index, row in data.iterrows():
    ...
    if tmpno % 10 == 0:
        print(tmpno)
    lineNo += 1
    lines.append("samian:ae_" + str(row['cpchp_id']) + " lado:interactsWith " + "samian:ae_" + str(row['dp_id']) + ".")
