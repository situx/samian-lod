...
file_out_1 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_ds_1.ttl"
file_out_2 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_ds_2.ttl"
...
for index, row in data.iterrows():
    ...
    if tmpno % 10000 == 0:
        print(tmpno)
    lineNo += 1
    lines.append("samian:ic_" + str(row['ic_id']) + " lado:disclosedAt " + "samian:loc_ds_" + str(row['ds_id']) + ".")
