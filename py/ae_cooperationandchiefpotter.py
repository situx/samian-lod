...
file_out = dir_path.replace("\\py", "\\ttl") + "\\" + "cooperationandchiefpotter.ttl"

# set input csv
csv = "cooperationandchiefpotter.csv"
...
for index, row in data.iterrows():
    ...
    lines.append("samian:ae_" + str(row['id']) + " " + "lado:hasStatus" + " lado:CooperationPotter .")
