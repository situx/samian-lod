...
file_out_1 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_1.ttl"
file_out_2 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_2.ttl"
file_out_3 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_3.ttl"
file_out_4 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_4.ttl"
file_out_5 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_5.ttl"
file_out_6 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_6.ttl"
file_out_7 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_7.ttl"
file_out_8 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_8.ttl"
file_out_9 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_9.ttl"
file_out_10 = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_ic_pf_10.ttl"
...
data = pd.read_csv(
    ...
    encoding='utf-8',
    sep='|',
    usecols=['ic_id', 'pf_id', 'weight'],
    dtype={'ic_id': str, 'pf_id': str, 'weight': str}
)
print(data.info())
...
for index, row in data.iterrows():
    ...
    if tmpno % 10000 == 0:
        print(tmpno)
    lineNo += 1
    lines.append("samian:ic_" + str(row['ic_id']) + " lado:representedBy " + "samian:pf_" + str(row['pf_id']) + ".")
    # amt
    ...
    lines.append("_:" + str(lineNo) + " rdf:predicate " + "lado:representedBy" + ".")
    lines.append("_:" + str(lineNo) + " rdf:object " + "samian:pf_" + str(row['pf_id']) + ".")
