...
file_out = dir_path.replace("\\py", "\\ttl") + "\\" + "inscriptiongraffito.ttl"

# set input csv
csv = "inscriptiongraffito.csv"
...
for index, row in data.iterrows():
    ...
    lines.append("samian:insc_" + str(row['id']) + " " + "lado:hasType" + " lado:Graffito .")
