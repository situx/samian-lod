...
file_out = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_plc_pc.ttl"
...
for index, row in data.iterrows():
    ...
    if tmpno % 50 == 0:
        print(tmpno)
    lineNo += 1
    lines.append("samian:plc_" + str(row['plc_id']) + " lado:hasLocation " + "samian:loc_pc_" + str(row['pc_id']) + ".")
