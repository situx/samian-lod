...
file_out = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_plc_ds.ttl"
...
for index, row in data.iterrows():
    ...
    if tmpno % 1000 == 0:
        print(tmpno)
    lineNo += 1
    lines.append("samian:plc_" + str(row['plc_id']) + " lado:hasLocation " + "samian:loc_ds_" + str(row['ds_id']) + ".")
