...
file_out = dir_path.replace("\\py", "\\ttl") + "\\" + "ct_plc_rl.ttl"
...
for index, row in data.iterrows():
    ...
    if tmpno % 100 == 0:
        print(tmpno)
    lineNo += 1
    lines.append("samian:plc_" + str(row['plc_id']) + " lado:hasLocation " + "samian:loc_rl_" + str(row['rl_id']) + ".")
